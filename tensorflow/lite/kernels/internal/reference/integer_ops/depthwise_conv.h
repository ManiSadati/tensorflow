...
inline void DepthwiseConvPerChannel(
  ...
  // -------------------- Fault Injection (FI) --------------------
  // Convention for DepthwiseConvPerChannel output (NHWC, batch fixed to 0):
  ...
  // Profiling: record output tensor dimensions + approximate op count.
  ...
  // Logging: dump output tensor for requested layers (batch fixed to 0).
  if (FI.isLoggedLayer()) {
